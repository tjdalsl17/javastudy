...
public class MainClass {
	...
	public static void ex03() {
		...
		// 1. 논리 AND의 경우 조건의 결과가 false인 경우가 발생하면 더 이상 동작x 최종 결과가 false로 정해졌기 때문
		// 2. 논리  OR의 경우 조건의 결과가 true인 경우가 발생하면 더 이상 동작x 최종 결과가 true로 정해졌기 때문
